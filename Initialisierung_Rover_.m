...
map = fct_markCircularObstacle(map, X_value_obs1, Y_value_obs1, r1 + safety);
...
map = fct_markCircularObstacle(map, X_value_obs2, Y_value_obs2, r2 + safety);
...
map = fct_markCircularObstacle(map, X_value_obs3, Y_value_obs3, r3 + safety);
